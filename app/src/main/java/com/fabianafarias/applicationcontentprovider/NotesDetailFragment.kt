...
import com.fabianafarias.applicationcontentprovider.database.NotesDataBaseHelper.Companion.DESCRIPTION_NOTES
...
class NotesDetailFragment : DialogFragment(), DialogInterface.OnClickListener {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        noteEditDescription = view.findViewById(R.id.not_edt_description) as EditText
